...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_logged_in_uses_correct_template(self):
        ...
        self.assertTemplateUsed(response, 'catalog/mybooks.html')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        response = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk':self.test_bookinstance1.pk,}), {'due_back':valid_date_in_future})
        self.assertRedirects(response, reverse('catalog:books-borrowed'))

    def test_form_invalid_renewal_date_past(self):
        login = self.client.login(username='testuser2', password='2HJ1vRV0Z&3iD')
        date_in_past = datetime.date.today() - datetime.timedelta(weeks=1)
        response = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}), {'due_back': date_in_past})
        self.assertEqual(response.status_code, 200)
    ...
    def test_form_invalid_renewal_date_future(self):
        ...
        response = self.client.post(reverse('catalog:renew-book-librarian', kwargs={'pk': self.test_bookinstance1.pk}), {'due_back': invalid_date_in_future})
        self.assertEqual(response.status_code, 200)
